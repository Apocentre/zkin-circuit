...
circom circuits/base64/encoder.circom  --r1cs --sym --wasm -o build
...
cd build/encoder_js
node generate_witness.js encoder.wasm ../../inputs/simple_encode.json witness.wtns
...
snarkjs groth16 setup encoder.r1cs pot12_final.ptau Encoder_0000.zkey

# Contribute to the phase 2 of the ceremony
snarkjs zkey contribute Encoder_0000.zkey Encoder_0001.zkey --name="1st Contributor Name" -v

# Export the verification key
snarkjs zkey export verificationkey Encoder_0001.zkey verification_key.json

# Generate a zk-proof associated to the circuit and the witness. This generates proof.json and public.json
snarkjs groth16 prove Encoder_0001.zkey witness.wtns proof.json public.json

# Verify the proof
snarkjs groth16 verify verification_key.json public.json proof.json

# Generate a Solidity verifier that allows verifying proofs on Ethereum blockchain
snarkjs zkey export solidityverifier Encoder_0001.zkey ../contracts/verifier.sol
